...
struct TopStyleData {
    static let last30Days = [
        (name: "ハイボール", sales: 916),
        (name: "ビール", sales: 820),
        (name: "レモンサワー", sales: 610),
        (name: "赤ワイン", sales: 350),
        (name: "白ワイン", sales: 144),
        (name: "日本酒", sales: 66)
    ]
    ...
    static let last12Months = [
        (name: "ハイボール", sales: 9631),
        (name: "ビール", sales: 6200),
        (name: "レモンサワー", sales: 7891),
        (name: "赤ワイン", sales: 3300),
        (name: "白ワイン", sales: 700),
        (name: "日本酒", sales: 1400)
    ]
}
